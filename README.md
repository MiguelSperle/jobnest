...
<p>
This project covers the following topics: Traditional Monolithic Architecture with Clean Architecture, SOLID, Messaging System combined with the implementation of the Inbox and Outbox patterns, 
